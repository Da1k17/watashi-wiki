...
## 機械可読の説明
- /llms.txt … 作品の概要・画面・API・実装済み/未実装（テキスト）
- /api/about … 同じ内容のJSON
- 画面トップの「この作品について」にも同じ要約

## 審査の方へ（確認手順）
- 公開URL: フォームに記載のURL。ログイン・課金は不要。マイクは無くても文字入力で進めます
- 手順: ①「はじめる」 ②インタビュー5問に文字かタップで答える ③Wikipedia風の自分のページが表示され、URLが /wiki/xxxxxx になる ④「履歴を表示」で版の一覧と差分 ⑤本文下の興味タグを押すと質問が3つ
